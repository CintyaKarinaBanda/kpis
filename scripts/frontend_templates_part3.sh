#!/bin/bash
# Tercera parte de las plantillas HTML para el frontend

# Función para crear el archivo dashboard.html
create_frontend_files_part3() {
  local TEMP_DIR=$1
  local USER_POOL_ID=$2
  local USER_POOL_CLIENT_ID=$3

  # Crear página de dashboard
  cat > "$TEMP_DIR/dashboard.html" << EOFDASHBOARD
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
EOFDASHBOARD
  ...
  cat > "$TEMP_DIR/error.html" << EOFERROR
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
